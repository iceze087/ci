<div class="row">
            ...
            <form action="/user/create" method="post">
             <div class="form-group">
                <label>ชื่อ</label>
                <input name="name" type="text" class="form-control" placeholder="กรอกชื่อ สกุล">
             </div>
            <div class="form-group">
                <label>อีเมล์</label>
            ...
            <div class="form-group">
                ...
                <input name="password" type="text" class="form-control" placeholder="รหัสผ่าน">
            </div>
            <div class="form-group">
                <label>ประเภทใช้งาน</label>
